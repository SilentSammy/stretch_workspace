...
def main(use_yolo, use_remote_computer, exposure):
    try:
        ...
        while True:
            ...
            interceptor.toy_visible = toy_target is not None
            ...
            if behavior == 'retract':
                ...
                if motion_on:
                    ...
                    interceptor.visual_servoing_cmd = cmd
                    cmd = interceptor.get_cmd()
