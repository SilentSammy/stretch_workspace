...
try:
    while True:
        ...
        head_display = cv2.resize(head_rgb, (640, 480))
        wrist_display = cv2.resize(wrist_rgb, (640, 480))
        
        # Display RGB feeds
        cv2.imshow('Head Camera', head_display)
        cv2.imshow('Wrist Camera', wrist_display)
